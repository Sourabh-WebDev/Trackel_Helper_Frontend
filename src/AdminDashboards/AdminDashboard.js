      ...
      <div className="position-relative">
        ...
        <div className="BackgroundTopContents" style={{ overflowX: "hidden" }}>
          ...
          <div className="d-flex align-items-center justify-content-between w-100 px-4 pb-4">
            ...
            <ColoredBtn
              onClick={() => {
                setCellColor({ type: "Complete", color: "green" });
              }}
            ...
            <ColoredBtn
              onClick={() => {
                setCellColor({ type: "Running", color: "yellow" });
              }}
            ...
            <ColoredBtn
              onClick={() => {
                setCellColor({ type: "Cancel", color: "gray" });
              }}
            ...
            <ColoredBtn
              onClick={() => {
                setCellColor({ type: "Hold", color: "#f08080" });
              }}
              btnName={"Hold Order"}
              bg={"#f08080"}
              color={"black"}
            ...
            <ColoredBtn
              onClick={() => {
                setCellColor({ type: "Due", color: "#adadec" });
              }}
              btnName={"Due Order"}
              bg={"#adadec"}
              color={"black"}
            ...
            <ColoredBtn
              onClick={() => {
                setCellColor({ type: "Pending", color: "#ffa500" });
              }}
          ...
          <div className="p-4">
            <AdminDataTable
              rows={RowDataFilter(rows, cellColor)}
              getRowClassName={getRowClassName}
              columns={columns}
              CustomToolbar={CustomToolbar}
              cellcolor={cellColor !== null ? cellColor.color : null}
            />
          </div>
        </div>
      </div>
