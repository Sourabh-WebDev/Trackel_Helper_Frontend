  ...
  return async (dispatch) => {
    ...
    try {
      ...
      if (response.status === 200) {
        dispatch({
          type: constant.HEAD_EXPENSE_API_SUCCESS,
...
export const UpdateHeadExpense = (id, formData) => {
  return async (dispatch) => {
    dispatch({ type: constant.UPDATE_HEAD_EXP_LOADING });
    try {
      const response = await axios.patch(
        API_URL + "/expense/updateheadexpense/" + id,
        formData
      );
      if (response.status === 200) {
        dispatch({
          type: constant.UPDATE_HEAD_EXP_SUCCESS,
          payload: response.data,
        });
      }
    } catch (error) {
      dispatch({ type: constant.UPDATE_HEAD_EXP_ERROR });
    }
  };
};
...
export const GetAllHeadExp = () => {
  return async (dispatch) => {
    ...
    try {
      ...
      if (response.status === 200) {
        dispatch({
          type: constant.GET_ALLHEADEXP_API_SUCCESS,
...
export const GetDeleteHeadExp = (id) => {
  return async (dispatch) => {
    ...
    try {
      const response = await axios.get(API_URL + "/expense/delete/" + id);
      if (response.status === 200) {
  ...
  return async (dispatch) => {
    ...
    try {
      const response = await axios.post(
        API_URL + "/expense/addexpense",
        formdata
      );
      if (response.status === 200) {
        dispatch({
          type: constant.GET_ADDEXP_API_SUCCESS,
          payload: response.data.data,
        });
...
export const GetAddCollections = (formdata) => {
  return async (dispatch) => {
    ...
    try {
      const response = await axios.post(
        API_URL + "/expense/addcollection",
        formdata
      );
      if (response.status === 200) {
        dispatch({
          type: constant.GET_ADD_COLLECTION_SUCCESS,
          payload: response.data.data,
        });
...
export const GetALLExpenses = () => {
  return async (dispatch) => {
    ...
    try {
      ...
      if (response.status === 200) {
        dispatch({
          type: constant.GET_ALL_EXP_API_SUCCESS,
          payload: response.data.data,
        });
      }
    } catch (error) {
...
export const GetAllCollection = () => {
  return async (dispatch) => {
    ...
    try {
      ...
      if (response.status === 200) {
        dispatch({
          type: constant.GET_ALL_COLL_API_SUCCESS,
          payload: response.data.data,
        });
      }
    } catch (error) {
...
export const DeleteCollectionById = async (id) => {
  try {
    const response = await axios.get(
      API_URL + "/expense/deletecollection/" + id
    );
    if (response.status === 200) {
